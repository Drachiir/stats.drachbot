...
def drachbot_overlay_api(playername):
    ...
    history = drachbot_db.get_matchistory(playerid, 30, earlier_than_wave10=True, req_columns=req_columns, skip_stats=True, sort_players=False, skip_game_refresh=True)
    # if not history:
